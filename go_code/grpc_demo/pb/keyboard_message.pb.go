...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=zplus.pcbook.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x7a, 0x70, 0x6c, 0x75, 0x73, 0x2e,
	...
	0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x7a, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f,
...
var file_keyboard_message_proto_goTypes = []interface{}{
	(Keyboard_Layout)(0), // 0: zplus.pcbook.Keyboard.Layout
	(*Keyboard)(nil),     // 1: zplus.pcbook.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: zplus.pcbook.Keyboard.layout:type_name -> zplus.pcbook.Keyboard.Layout
