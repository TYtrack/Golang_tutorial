...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=zplus.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x7a, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x70,
	...
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x7a, 0x70, 0x6c, 0x75, 0x73, 0x2e,
	...
	0x7a, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d,
	...
	0x53, 0x44, 0x10, 0x02, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: zplus.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: zplus.pcbook.Storage
	(*Memory)(nil),      // 2: zplus.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: zplus.pcbook.Storage.driver:type_name -> zplus.pcbook.Storage.Driver
	2, // 1: zplus.pcbook.Storage.memory:type_name -> zplus.pcbook.Memory
