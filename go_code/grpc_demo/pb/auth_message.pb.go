...
var file_auth_message_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x7a, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f,
	...
	0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x1a, 0x2e, 0x7a, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x70,
	0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x7a, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
...
var file_auth_message_proto_goTypes = []interface{}{
	(*LoginRequest)(nil),  // 0: zplus.pcbook.LoginRequest
	(*LoginResponse)(nil), // 1: zplus.pcbook.LoginResponse
}
var file_auth_message_proto_depIdxs = []int32{
	0, // 0: zplus.pcbook.AuthService.Login:input_type -> zplus.pcbook.LoginRequest
	1, // 1: zplus.pcbook.AuthService.Login:output_type -> zplus.pcbook.LoginResponse
...
func (c *authServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zplus.pcbook.AuthService/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zplus.pcbook.AuthService/Login",
	}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "zplus.pcbook.AuthService",
