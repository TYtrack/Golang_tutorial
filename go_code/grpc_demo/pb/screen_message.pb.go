...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=zplus.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x32, 0x1f, 0x2e, 0x7a, 0x70, 0x6c, 0x75, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
	...
	0x05, 0x70, 0x61, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x7a,
	0x70, 0x6c, 0x75, 0x73, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: zplus.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: zplus.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: zplus.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: zplus.pcbook.Screen.resolution:type_name -> zplus.pcbook.Screen.Resolution
	0, // 1: zplus.pcbook.Screen.panel:type_name -> zplus.pcbook.Screen.Panel
